...
// The variable foo is declared within the scope of the for loop. This means that "foo" is only accessible within the curly braces {} of the loop where it's defined.
...
// Both print statements compile because x is defined in the global scope
...
greeting(greeting: "Hi there", name: "Prakul")
greeting(greeting: nil, name: "Prakul")
