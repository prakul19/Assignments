...
let favoriteBook = Book(title: "To Kill a Mockingbird", author: "Harper Lee", pages: 324, price: 9.99)
...
let expectedCentimeters = 65.0 * 2.54
if someonesHeight.heightInCentimeters == expectedCentimeters {
    print("The height in centimeters matches the expected value (165.1)")
} else {
    print("The height in centimeters does not match the expected value")
}
...
let expectedCentimeters2 = 70.0 * 2.54
if myHeight.heightInCentimeters == expectedCentimeters2 {
    print("The height in centimeters matches the expected value ")
} else {
    print("The height in centimeters does not match the expected value")
}
