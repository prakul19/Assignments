 ...
 */
var walkingChallenges: [String] = ["Walk 3 miles a day", "Walk 10,000 steps daily"]

var runningChallenges: [String] = ["Run 5 times a week", "Run a 10km race"]

print("Walking Challenges:")
for challenge in walkingChallenges {
    print(challenge)
}
...
var committedChallenges: [String] = ["Walk 3 miles a day", "Run a 10k race"]

committedChallenges.append("Do 50 push-ups a day")
committedChallenges.append("Bench press 1.5 times your body weight")

print("Committed Challenges:")
for challenge in committedChallenges {
    print(challenge)
}
