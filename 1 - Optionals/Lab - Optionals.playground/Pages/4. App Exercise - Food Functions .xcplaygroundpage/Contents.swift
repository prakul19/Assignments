...
func getMealForTime(time: String) -> Meal? {
    return meals[time]
}

if let breakfastMeal = getMealForTime(time: "Breakfast") {
    print("Breakfast Meal:", breakfastMeal)
} else {
    print("No meal logged for Breakfast.")
}

if let lunchMeal = getMealForTime(time: "Lunch") {
    print("Lunch Meal:", lunchMeal)
} else {
    print("No meal logged for Lunch.")
}

if let dinnerMeal = getMealForTime(time: "Dinner") {
    print("Dinner Meal:", dinnerMeal)
} else {
    print("No meal logged for Dinner.")
}
...
func getMealLogFromDevice() -> [String: Any] {
...
let mealLog = getMealLogFromDevice()
print("Meal Log from Device:", mealLog)
