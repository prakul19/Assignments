 ...
 */
//func checkAge(_ userInputAge: String) {
...
//
//let anotherUserInputAge = "25"
//checkAge(anotherUserInputAge)


//:  Go back and update your function to return the age as an integer. Will your function always return a value? Make sure your return type accurately reflects this. Call the function and print the return value.
func checkAge(_ userInputAge: String) -> Int? {
    if let age = Int(userInputAge), age > 0 {
        return age
    } else {
        print("Sorry, something went wrong. Can you please re-enter your age?")
        return nil
...
let anotherUserInputAge = "25"
if let age = checkAge(anotherUserInputAge) {
    print("User's age is:", age)
}
...
func purchaseItem(itemName: String) -> Double? {
    if let price = prices[itemName], let stockQuantity = stock[itemName], stockQuantity > 0 {
        return price
    } else {
        return nil
    }
...
let itemName = "Chips"
if let itemCost = purchaseItem(itemName: itemName) {
